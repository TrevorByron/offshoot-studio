...
2. **Tags** — Rendered in the header; use `badges` from `CaseStudyContent` (e.g. "Design Sprints", "Team Expansion", "UI/UX Refinement", "Design systems"). Icons are mapped in `case-study-header.tsx`.
...
3. The page at `app/case-studies/[slug]` renders with the shared template. No extra styles or animations per page.
