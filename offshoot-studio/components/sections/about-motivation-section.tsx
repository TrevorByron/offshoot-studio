    ...
    <SectionWrapper>
      <div className="max-w-4xl">
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none space-y-6">
          ...
          <p className="text-lg text-muted-foreground">
            He's relentlessly energetic (think Energizer Bunny that learned to code). This shows up in how Tiger Team Studios works: fast feedback loops, quick iterations, daily progress, zero bureaucracy.
          </p>
          <p className="text-lg text-muted-foreground">
